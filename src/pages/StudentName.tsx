    ...
    <div className="min-h-screen bg-gradient-hero">
      <div className="max-w-2xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center justify-between mb-12">
          <Link to="/student" className="flex items-center text-white hover:text-white/80 transition-colors">
        ...
        <Card className="p-12 border-0 bg-white/10 backdrop-blur-sm">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-white mb-4">Tell us about yourself</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <label className="block text-white font-medium mb-2">Select Your Class</label>
